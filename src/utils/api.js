...
// Fungsi untuk membuat instance API dengan baseURL dinamis
export const createApiInstance = (baseUrl) => {
    return ofetch.create({
        baseURL: baseUrl || import.meta.env.VITE_API_BASE_URL || '/api', // baseURL default jika tidak ada parameter
